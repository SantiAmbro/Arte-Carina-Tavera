...
/**
 * Created by Santiago Ambrosetti on 13/09/2015.
 *
...
public class MailSenderUtil {
    ...
    private final static String FROM = "noreply.artecarinatavera@gmail.com";
    private final static String FROM_PW = "artecarinatavera";
    private final static String HOST = "smtp.gmail.com";

    public static void send(String[] to, String htmlMsg) throws MessagingException {
